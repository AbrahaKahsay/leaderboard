...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_createGame_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/createGame.js */ \"./src/modules/createGame.js\");\n/* harmony import */ var _modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/addScore.js */ \"./src/modules/addScore.js\");\n\n\n\n\nconst newGame = {\n  name: 'jump ten times',\n};\nconst game = JSON.stringify(newGame);\nconst list = document.getElementById('scores-list');\nconst form = document.getElementById('form');\nconst userName = document.getElementById('name');\nconst userScore = document.getElementById('score');\nconst refresh = document.getElementById('refresh');\n\nif (!(0,_modules_createGame_js__WEBPACK_IMPORTED_MODULE_1__.getID)()) {\n  await (0,_modules_createGame_js__WEBPACK_IMPORTED_MODULE_1__.creatGame)(game);\n}\n\n(0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.getScores)()\n  .then((result) => (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.createList)(result.result, list));\n\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.addScore)(JSON.stringify({\n    user: userName.value,\n    score: userScore.value,\n  }));\n  (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.createScore)(userName.value, userScore.value, list);\n});\n\nrefresh.addEventListener('click', () => {\n  (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.getScores)().then((result) => (0,_modules_addScore_js__WEBPACK_IMPORTED_MODULE_2__.createList)(result.result, list));\n});\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } }, 1);\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
